...
urlpatterns = [
    ...
    path('report_main', views.report_main, name='report_main'), #u
    path('report/<int:form_id>/', views.report, name='report'), #u หน้ารายงาน
    ...
    path('update_template/', update_template, name='update_course'),
